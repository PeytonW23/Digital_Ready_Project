...
def go(starting: str) -> None:
    ...
    while Game_start:
        ...
        "HeartsJack", "HeartsQueen", "HeartsKing", "HeartsAce", "Spades2", "Spades3", "Spades4", "Spades5", "Spades6", "Spades7", "Spades8", "Spades9", "Spades10", "SpadesJack",
        "SpadesQueen", "SpadesKing", "SpadesAce", "Clubs2", "Clubs3", "Clubs4", "Clubs5", "Clubs6", "Clubs7", "Clubs8", "Clubs9", "Clubs10",
        "ClubsJack", "ClubsQueen", "ClubsKing","ClubsAce", "Diamonds2", "Diamonds3", "Diamonds4", "Diamonds5", "Diamonds6", "Diamonds7", "Diamonds8", "Diamonds9", "Diamonds10",
        ...
        if choice == "Start" or choice == "start":
            ...
            while Your_turn:
                ...
                user_choice = [input("What Card do you want? Type Your Answer as SuitRank, Ex: 'Hearts3' or 'SpadesKing' \n")]
